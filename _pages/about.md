...
My research focuses on **computer architecture and systems for AI**, broadly in these areas:

1. Computer architecture and hardware-software co-design.
2. Systems for AI and machine learning workloads.
